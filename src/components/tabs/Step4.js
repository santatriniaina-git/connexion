...
const labelsCareer = [
  "Site carrière avancée",
  "Gestion de recrutement",
  "Statistiques et Analytique",
  "Jobboard sur mesure"
];

function NumberedLabels({labels}) {
  return (
...
function Step4({ nextStep }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-row-2 gap-x-20 gap-y-11 items-center p-[9.313rem]">
      ...
      <div className="flex flex-col space-y-2">
        ...
        >
          <NumberedLabels labels={labelsNeed} />
        </BigDisclosure>
        <BigDisclosure
          title="Recrutement et site carrière"
          classParent="bg-white my-2 px-1 py-2 h-26"
        >
          <NumberedLabels labels={labelsCareer} />
        </BigDisclosure>
      </div>
      <div>
      <div className="grid grid-cols-2 gap-x-20 gap-y-11 mr-[16rem]">
        <div>
